...
public class EntityKillActivationEvent extends EntityTargetActivationEvent {

    private static final HandlerList HANDLER_LIST = new HandlerList();

    public EntityKillActivationEvent(@NotNull Entity entity, String id, Entity target) {
