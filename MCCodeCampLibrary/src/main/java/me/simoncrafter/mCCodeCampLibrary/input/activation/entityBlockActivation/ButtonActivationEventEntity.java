...
public class ButtonActivationEventEntity extends EntityBlockActivationEvent {

    private static final HandlerList HANDLER_LIST = new HandlerList();

    public ButtonActivationEventEntity(@NotNull Entity entity, String id, Block block) {
